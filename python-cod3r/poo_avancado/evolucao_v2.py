...
class Humano:
    ...
    @staticmethod
    def especies():
        adjetivos = ('Habilis', 'Erectus', 'Neanderthalesnsis', 'Sapiens')
...
if __name__ == '__main__':
    ...
    print(f'Evollução (a partir da instancia): {",".join(jose.especies())}')
    print(f'Homo Sapines evoluido? {HomoSapiens.is_evoluido()}')
